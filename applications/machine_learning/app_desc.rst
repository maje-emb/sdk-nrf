...
.. list-table:: nRF Machine Learning build types
   ...
   * - Single-core
     ...
     - Configuration that does not use :term:`Peripheral Processor (PPR)` for data sampling.
...
.. include:: /includes/build_and_run_ns.txt
  ...
  **nRF54H20 DK**
   ...
   To build the application for the nRF54H20 PDK with the simulated sensor on the PPR core (dual-core application), run the following command:
